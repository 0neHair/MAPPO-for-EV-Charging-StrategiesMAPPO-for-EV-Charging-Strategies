                        ...
                        with torch.no_grad():
                            ...
                            if args.ps:
                                ...
                                raction, rlog_prob = agents[agent_i].select_raction(
                                    obs_n[e][agent_i], obs_mask_n[e][agent_i]
                                )
                                if not args.ctde:
                                ...
                                agents[agent_i].rolloutBuffer.rpush_last_state(
                                    rstate=obs_n[e][agent_i], 
                                    share_rstate=share_obs_,
                                    action=raction, 
                    ...
                    if activate_to_act[e][i]:
                        with torch.no_grad():
                            ...
                            if args.ps:
                                ...
                                caction, raction, log_prob = agents[agent_i].select_action(
                                        obs_n[e][agent_i],
                                ...
                                agents[agent_i].rolloutBuffer.push_last_state(
                                    ...
                                    caction=caction, raction=raction,
                                    action_mask=obs_mask_n[e][agent_i],
                                    log_prob=log_prob,
                                    env_id=e
                                    )
